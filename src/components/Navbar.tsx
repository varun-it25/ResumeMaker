  ...
  return (
    <header className="px-6 py-3 flex justify-between items-center border-b bg-white dark:bg-zinc-900 dark:border-zinc-800 transition-colors">
      ...
      <div className="relative flex items-center space-x-4 max-w-sm">
        {
          isFileNameSelected
          ? ( <Input className="w-fit border-0 border-b border-zinc-300 dark:border-zinc-700 dark:bg-transparent rounded-none font-medium text-zinc-700 dark:text-zinc-200 bg-transparent focus-visible:ring-0 focus-visible:border-zinc-900 dark:focus-visible:border-white focus-visible:outline-none" placeholder="Jake's Resume" value={fileName} onChange={(e) => setFileName(e.target.value)} onBlur={focusOut} autoFocus /> )
              ...
              <DialogDescription>
                <div className="space-y-2.5">
                  ...
                  <div className="relative">
                    <Input placeholder="https://www.xyz.com/resume/oijIUjinByOIjB08nJ" type="text" readOnly />
                    <div className="absolute cursor-pointer bottom-1.5 right-2 hover:bg-accent w-6 h-6 rounded-md flex justify-center items-center">
                      <Copy size={12} />
                    </div>
                  </div>
                </div>
        ...
        <Popover>
          <PopoverTrigger>
            <div className="w-10 h-10 rounded-full bg-accent overflow-hidden">
              <img src={ProfilePic} alt="Profile Pic" className="w-full h-full rounded-full object-cover" />
            </div>
          </PopoverTrigger>
          ...
          <PopoverContent className="w-fit mr-3">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center space-x-3 border-b pb-2">
                <img src={ProfilePic} alt="Profile Pic" className="w-10 h-10 rounded-full object-cover" />
